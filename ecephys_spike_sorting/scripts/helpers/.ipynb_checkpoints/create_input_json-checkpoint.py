...
def createInputJson(output_file, 
                    ...
                    include_pcs = False,
                    snr_min = 1.0, #changed from 2.0, Emily's more stringent condition
                    mua_fr_min = 0.10,
                    halfwidth_max = 0.30, # matching Emily
                    wide_halfwidth_max = 0.30, # Emily allows 0.35 in HPC
                    repo_slope = 0, # matching Emily
                    depth = 3200, # matching Emily
                    isi_viol_max = 0.4, #changed from 0.2, Emily's more stringent condition
                    contam_rate_max = 25, # changed from 15, Emily's more stringent condition
                    ):
    ...
    catGTPath = r'C:\Users\Python\Desktop\spiketools\CatGT-win'
    tPrime_path=r'C:\Users\Python\Desktop\spiketools\TPrime-win'
    cWaves_path=r'C:\Users\Python\Desktop\spiketools\C_Waves-win'
